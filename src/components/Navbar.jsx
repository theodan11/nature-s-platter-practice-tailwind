    ...
    return (
        <div className='w-screen flex justify-center '>
            <div className=' flex justify-between md:hidden w-full px-3 py-3 border-b-1 border-green-400'>
                <img className="h-11 w-11" src="logo_mobile.png" alt="" />
                <img className="h-10 w-10" src="bars-3.png" alt="" />
            </div>

            <div className='hidden items-center md:flex sm:flex-row justify-between md:py-3    w-[1080px] '>
                <img className='w-35 h-15' src="logo.png" alt="" />
                ...
                <div className='flex items-center space-x-3'>
                    <img className='w-5 h-5 cursor-pointer' src="search_icon.png" alt="" />
                    <img className='w-5 h-5 cursor-pointer mr-4' src="cart.png" alt="" />
